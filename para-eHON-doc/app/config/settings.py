...
class Settings:
    ...
    def __init__(self):
        ...
        self.EXCEL_PATH = os.getenv(
            "EXCEL_PATH", 
            str(self.BASE_DIR / "files" / "Paraplanner_Extraction and Rules_v2_200126.xlsx")
        )
        self.SHEET_NAME = os.getenv("SHEET_NAME", "Extraction Fields_JSON 20012026")
        self.TEMPLATE_PATH = os.getenv(
            "TEMPLATE_PATH", 
            str(self.BASE_DIR / "files" / "eHON Template_v2_200126.docx")
        )
